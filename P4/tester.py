...
class AllTests (unittest.TestCase):
    ...
    def test_histogram_1(self):
        self.assertEqual(histogram(gray_image_1.input),histogram_1.output)
    def test_histogram_2(self):
        self.assertEqual(histogram(gray_image_2.input),histogram_2.output)
    def test_histogram_3(self):
        self.assertEqual(histogram(gray_image_3.input),histogram_3.output)
    def test_histogram_4(self):
        self.assertEqual(histogram(gray_image_4.input),histogram_4.output)
    def test_histogram_5(self):
        self.assertEqual(histogram(gray_image_5.input),histogram_5.output)
    def test_histogram_6(self):
        self.assertEqual(histogram(gray_image_6.input),histogram_6.output)
    def test_histogram_7(self):
        self.assertEqual(histogram(gray_image_7.input),histogram_7.output)
    def test_histogram_8(self):
        self.assertEqual(histogram(gray_image_8.input),histogram_8.output)

    ########################################################################### 

    def test_flip_1(self):
        array = gray_image_1.input
        flip(array, 'horizontal')
        self.assertEqual(array,flip_1.output)
        importlib.reload(gray_image_1)
    def test_flip_2(self):
        array = gray_image_2.input
        flip(array, 'horizontal')
        self.assertEqual(array,flip_2.output)
        importlib.reload(gray_image_2)
    def test_flip_3(self):
        array = gray_image_3.input
        flip(array, 'horizontal')
        self.assertEqual(array,flip_3.output)
        importlib.reload(gray_image_3)
    def test_flip_4(self):
        array = gray_image_4.input
        flip(array, 'horizontal')
        self.assertEqual(array,flip_4.output)
        importlib.reload(gray_image_4)
    def test_flip_5(self):
        array = gray_image_5.input
        flip(array, 'horizontal')
        self.assertEqual(array,flip_5.output)
        importlib.reload(gray_image_5)
    def test_flip_6(self):
        array = gray_image_6.input
        flip(array, 'vertical')
        self.assertEqual(array,flip_6.output)
        importlib.reload(gray_image_6)
    def test_flip_7(self):
        array = gray_image_7.input
        flip(array, 'vertical')
        self.assertEqual(array,flip_7.output)
        importlib.reload(gray_image_7)
    def test_flip_8(self):
        array = gray_image_8.input
        flip(array, 'vertical')
        self.assertEqual(array,flip_8.output)
        importlib.reload(gray_image_8)
    def test_flip_9(self):
        array = gray_image_9.input
        flip(array, 'vertical')
        self.assertEqual(array,flip_9.output)
        importlib.reload(gray_image_9)

    ########################################################################### 

    def test_rotate_1(self):
        array = gray_image_1_square.input
        rotate(array)
        self.assertEqual(array,rotate_1.output)
    def test_rotate_2(self):
        array = gray_image_2_square.input
        rotate(array)
        self.assertEqual(array,rotate_2.output)
    def test_rotate_3(self):
        array = gray_image_3_square.input
        rotate(array)
        self.assertEqual(array,rotate_3.output)
    def test_rotate_4(self):
        array = gray_image_4_square.input
        rotate(array)
        self.assertEqual(array,rotate_4.output)
    def test_rotate_5(self):
        array = gray_image_5_square.input
        rotate(array)
        self.assertEqual(array,rotate_5.output)
    def test_rotate_6(self):
        array = gray_image_6_square.input
        rotate(array)
        self.assertEqual(array,rotate_6.output)
    def test_rotate_7(self):
        array = gray_image_7_square.input
        rotate(array)
        self.assertEqual(array,rotate_7.output)
    def test_rotate_8(self):
        array = gray_image_8_square.input
        rotate(array)
        self.assertEqual(array,rotate_8.output)
    def test_rotate_9(self):
        array = gray_image_9_square.input
        rotate(array)
        self.assertEqual(array,rotate_9.output)

    ########################################################################### 

    def test_crop_1(self):
        self.assertEqual(crop(color_image_1.input, (0,0), 3, 5),crop_1.output)
    def test_crop_2(self):
        self.assertEqual(crop(color_image_2.input, (6,4), 5, 4),crop_2.output)
    def test_crop_3(self):
        self.assertEqual(crop(color_image_3.input, (0,10), 22, 1),crop_3.output)
    def test_crop_4(self):
        self.assertEqual(crop(color_image_4.input, (30,0), 1, 29),crop_4.output)
    def test_crop_5(self):
        self.assertEqual(crop(color_image_5.input, (2,13), 12, 25),crop_5.output)
    def test_crop_6(self):
        self.assertEqual(crop(color_image_6.input,(57,53), 1, 1),crop_6.output)
    def test_crop_7(self):
        self.assertEqual(crop(color_image_7.input,(27,33), 14, 33),crop_7.output)
    def test_crop_8(self):
        self.assertEqual(crop(color_image_8.input,(50,60), 26, 8),crop_8.output)

    ########################################################################### 
    
    def test_color2gray_1(self):
        self.assertEqual(color2gray(color_image_1.input),color2gray_1.output)
    def test_color2gray_2(self):
        self.assertEqual(color2gray(color_image_2.input),color2gray_2.output)
    def test_color2gray_3(self):
        self.assertEqual(color2gray(color_image_3.input),color2gray_3.output)
    def test_color2gray_4(self):
        self.assertEqual(color2gray(color_image_4.input),color2gray_4.output)
    def test_color2gray_5(self):
        self.assertEqual(color2gray(color_image_5.input),color2gray_5.output)
    def test_color2gray_6(self):
        self.assertEqual(color2gray(color_image_6.input),color2gray_6.output)
    def test_color2gray_7(self):
        self.assertEqual(color2gray(color_image_7.input),color2gray_7.output)
    def test_color2gray_8(self):
        self.assertEqual(color2gray(color_image_8.input),color2gray_8.output)

    ########################################################################### 
    
    def test_extract_layer_1(self):
        self.assertEqual(extract_layer(color_image_1.input, 'red'),extract_layer_1.output)
    def test_extract_layer_2(self):
        self.assertEqual(extract_layer(color_image_2.input, 'red'),extract_layer_2.output)
    def test_extract_layer_3(self):
        self.assertEqual(extract_layer(color_image_3.input, 'red'),extract_layer_3.output)
    def test_extract_layer_4(self):
        self.assertEqual(extract_layer(color_image_4.input, 'green'),extract_layer_4.output)
    def test_extract_layer_5(self):
        self.assertEqual(extract_layer(color_image_5.input, 'green'),extract_layer_5.output)
    def test_extract_layer_6(self):
        self.assertEqual(extract_layer(color_image_6.input, 'green'),extract_layer_6.output)
    def test_extract_layer_7(self):
        self.assertEqual(extract_layer(color_image_7.input, 'blue'),extract_layer_7.output)
    def test_extract_layer_8(self):
        self.assertEqual(extract_layer(color_image_8.input, 'blue'),extract_layer_8.output)
    ...
    def test_scale_1(self):
        array = gray_image_1.input
        scale(array, 8)
        self.assertEqual(array,scale_1.output)
        importlib.reload(gray_image_1)
    def test_scale_2(self):
        array = gray_image_2.input
        scale(array, 6)
        self.assertEqual(array,scale_2.output)
        importlib.reload(gray_image_2)
    def test_scale_3(self):
        array = gray_image_3.input
        scale(array, 5)
        self.assertEqual(array,scale_3.output)
        importlib.reload(gray_image_3)
    def test_scale_4(self):
        array = gray_image_4.input
        scale(array, 4)
        self.assertEqual(array,scale_4.output)
        importlib.reload(gray_image_4)
    def test_scale_5(self):
        array = gray_image_5.input
        scale(array, 3)
        self.assertEqual(array,scale_5.output)
        importlib.reload(gray_image_5)
    def test_scale_6(self):
        array = gray_image_6.input
        scale(array, 2)
        self.assertEqual(array,scale_6.output)
        importlib.reload(gray_image_6)
    def test_scale_7(self):
        array = gray_image_7.input
        scale(array, -2)
        self.assertEqual(array,scale_7.output)
        importlib.reload(gray_image_7)
    def test_scale_8(self):
        array = gray_image_8.input
        scale(array, -3)
        self.assertEqual(array,scale_8.output)
        importlib.reload(gray_image_8)
    def test_scale_9(self):
        array = gray_image_9.input
        scale(array, -5)
        self.assertEqual(array,scale_9.output)
        importlib.reload(gray_image_9)

    ###########################################################################

    def test_compress_1(self):
        self.assertEqual(compress(gray_image_1.input),compress_1.output)
    def test_compress_2(self):
        self.assertEqual(compress(gray_image_2.input),compress_2.output)
    def test_compress_3(self):
        self.assertEqual(compress(gray_image_3.input),compress_3.output)
    def test_compress_4(self):
        self.assertEqual(compress(gray_image_4.input),compress_4.output)
    def test_compress_5(self):
        self.assertEqual(compress(gray_image_5.input),compress_5.output)
    def test_compress_6(self):
        self.assertEqual(compress(gray_image_6.input),compress_6.output)
    def test_compress_7(self):
        self.assertEqual(compress(gray_image_7.input),compress_7.output)
    def test_compress_8(self):
        self.assertEqual(compress(gray_image_8.input),compress_8.output)

    ########################################################################### 
    
    def test_median_filter_1(self):
        self.assertEqual(median_filter(gray_image_1.input),median_filter_1.output)
    def test_median_filter_2(self):
        self.assertEqual(median_filter(gray_image_2.input),median_filter_2.output)
    def test_median_filter_3(self):
        self.assertEqual(median_filter(gray_image_3.input),median_filter_3.output)
    def test_median_filter_4(self):
        self.assertEqual(median_filter(gray_image_4.input),median_filter_4.output)
    def test_median_filter_5(self):
        self.assertEqual(median_filter(gray_image_5.input),median_filter_5.output)
    def test_median_filter_6(self):
        self.assertEqual(median_filter(gray_image_6.input),median_filter_6.output)
    def test_median_filter_7(self):
        self.assertEqual(median_filter(gray_image_7.input),median_filter_7.output)
    def test_median_filter_8(self):
        self.assertEqual(median_filter(gray_image_8.input),median_filter_8.output)

    ########################################################################### 

    def test_extra_credit_fill_1(self):
        self.assertEqual(fill(gray_image_1_fill.input,70, (33,83)),fill_1.output)
    def test_extra_credit_fill_2(self):
        self.assertEqual(fill(gray_image_2_fill.input, 211, (33,117)),fill_2.output)
    def test_extra_credit_fill_3(self):
        self.assertEqual(fill(gray_image_3_fill.input, 33, (37,99)),fill_3.output)
    def test_extra_credit_fill_4(self):
        self.assertEqual(fill(gray_image_4_fill.input, 199, (73,37)),fill_4.output)
    def test_extra_credit_fill_5(self):
        self.assertEqual(fill(gray_image_5_fill.input, 3, (9,63)),fill_5.output)
